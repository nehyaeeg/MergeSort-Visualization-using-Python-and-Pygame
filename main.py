...
def main():
    ...
    lst, lstwrapper = random_number_generator(10,1,100) # random initialization
        ...
        for event in pygame.event.get(): # interaction
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_b:
                    ...
                    game_screen.lst, game_screen.lst_wrapper =  random_number_generator(10,1,100) # update list
